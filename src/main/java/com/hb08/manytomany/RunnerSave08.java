...
public class RunnerSave08 {
    public static void main(String[] args) {
        ...
        //because student is owner side , we set books to students
...
//        student1.setBookList(bookList);
        ...
        Transaction tx = session.beginTransaction();  //to send our manipulations to database
